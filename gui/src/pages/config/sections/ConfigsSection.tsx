                        ...
                        <div className="space-y-1 overflow-hidden">
                          {errors.map((error, errorIndex) => (
                            <div
                              ...
                              } rounded border border-solid border-transparent px-2 py-1 text-xs break-all ${error.uri ? "cursor-pointer " + (error.fatal ? "hover:border-error" : "hover:border-yellow-500") : ""}`}
                            >
                              {error.message}
                            </div>
                          ))}
